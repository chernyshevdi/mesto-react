...
function closeAllPopups() {
  ...
  return(
    ...
    <PopupWithForm name = {'type_profile'} title={'Редактировать профиль'} children={
      <>
    ...
    />
    <PopupWithForm name = {'type_card-add'} title={'Новое место'} children = {
      <>
      ...
      onClose={closeAllPopups}
    />
    <PopupWithForm name = {'avatar'} title={'Вы уверены?'} children = {
        <>
